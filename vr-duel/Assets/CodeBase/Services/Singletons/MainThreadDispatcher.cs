...
namespace CodeBase.Services.Singletons
{
    ...
    {
        public static MainThreadDispatcher Instance => GetOrCreateInstance();
        ...
        private static MainThreadDispatcher GetOrCreateInstance()
        {
        ...
        private static MainThreadDispatcher CreateInstance()
        {
