...
namespace CodeBase.Behaviours.Input
{
    ...
    public static class XRStatics
    {
        public static InputFeatureUsage<bool> GetFeature(XRButton button)
        {
            switch (button)
            {
                ...
                case XRButton.Secondary2DAxisClick: return CommonUsages.secondary2DAxisClick;
                case XRButton.Secondary2DAxisTouch: return CommonUsages.secondary2DAxisTouch;   
